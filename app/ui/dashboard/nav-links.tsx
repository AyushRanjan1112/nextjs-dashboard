  ...
  return (
    <>
      {links.map((link) => {
        ...
        return (
          // We could use <a> instead of <Link> but <Link> is preferred cause <a> does full page refresh while navigating and <Link> allows to do client-side navigation with Javascript
